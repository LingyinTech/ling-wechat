        ...
        <div class="order-shadow" style="">
            ...
            <table class="newTabNoColor" style="">
                ...
                <tr style="height: 60px;">
                    <td colspan="2">
                        <img src="<?= Url::to('@web/static/orderFlow/images/logo.png') ?>">
                    </td>
                    <td colspan="11">
                    ...
                    <td colspan="18">
                        <div style="width: auto; height: auto;">
                            <?php echo \kucha\ueditor\UEditor::widget(['name' => 'thumb', 'clientOptions' => [
                                ...
                                'toolbars' => [
                                    [
                                        'fullscreen', 'undo', 'simpleupload', 'insertimage',
                                    ],
                                ]]
                            ]); ?>
                        </div>
            ...
            <div class="xiadan_header guideTips1 " style=" width:100%;">
                <a href="javascript:void();" id="rate" class="b-upload">
                    ...
                    <div class="upload-file-name btn-third">
                        <img class="zip-clode" src="<?= Url::to('@web/static/orderFlow/images/up-cloud.png') ?>">
                        <span class="zip-change" style="display:none;"><img
                                src="<?= Url::to('@web/static/orderFlow/images/zip_change.png') ?>"></span>
                        <span id="preview1">点击或拖拽上传资料包</span>
                        <img src="<?= Url::to('@web/static/orderFlow/images/loading.gif') ?>" id="loading1"
            ...
            <?php if($model->order_state <= 0):?>
		        <span class="tankBtn">
		        	...
		        	<div class="order-btn-tishi" id="caogao-btn-tishi" style="display: none;">
		        		<img src="<?= Url::to('@web/static/orderFlow/images/order-loading.gif') ?>">
		        		<span>正在存储...</span>
		        	</div>
		        </span>
