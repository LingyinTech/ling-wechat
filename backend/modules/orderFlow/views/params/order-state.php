            ...
            <?php $form = ActiveForm::begin([
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?= $form->field($model, 'code')->input('text', ['maxlength' => '128','placeholder'=>'订单状态编码']) ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?= $form->field($model, 'name')->input('text', ['maxlength' => '128','placeholder'=>'订单状态名称']) ?>
                        </div>
                    </div>
                    <div class="form-group">
